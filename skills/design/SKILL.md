---
name: design
description: "Use when the user asks to design a logo, create a CIP or corporate identity, generate brand mockups, build slides, design a banner, generate an icon, create social photos or social media images, or define a brand identity or design system — for platforms like Facebook, Twitter, LinkedIn, YouTube, Instagram, Pinterest, TikTok, Threads, Google Ads."
