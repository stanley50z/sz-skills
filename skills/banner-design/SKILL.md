---
name: banner-design
description: "Use when the user asks to design, create, or generate a banner — for social media (Facebook, Twitter/X, LinkedIn, YouTube, Instagram), Google Display ads, website heroes, creative assets, or print. Styles include minimalist, gradient, bold typography, glassmorphism, 3D, neon, retro, duotone, editorial, collage."
