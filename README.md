...
| [setup-git-repo](skills/setup-git-repo/) | Bootstrap a local and remote GitHub repository, add the engineering-skills config, publish OpenWiki docs, and install a local post-commit documentation update hook |
