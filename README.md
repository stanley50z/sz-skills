...
| [pr-codex-review](skills/pr-codex-review/) | Loop on a PR's automated Codex review — fix valid points, spin off out-of-scope ones as issues, merge on thumbs-up (user-invoked only) |
