...
| [grill-with-docs](skills/grill-with-docs/) | Stress-test plans against project language and documented decisions | [mattpocock/skills](https://github.com/mattpocock/skills/tree/main/skills/engineering/grill-with-docs) | Keeps the skill standalone for this repo while cherry-picking upstream v1.1 grilling gates and facts-vs-decisions rules |
...
| [handoff](skills/handoff/) | Compact the current conversation into a handoff document for another agent to pick up | [mattpocock/skills](https://github.com/mattpocock/skills/tree/main/skills/productivity/handoff) |
